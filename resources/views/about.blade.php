  ...
  <body>
    ...
    <div class="slider__bg">
      ...
      <div class="auto__container">
        ...
        <h4>Trading and losing money all the time? <span>Sounds familiar?</span></h4>
            <h4>
              With copy paste trading clients see next level
              results
            </h4>
            
          </div>
          <div class="slider__bottom">
            <h3>We area the team of traders with prooven success history
Example of last Emerging Coin Alert:</h3>
    ...
    <!-- Alert Start
    ============================= -->
    <section class="alert" data-aos="fade-up">
      <div class="alert__bg">
        <img src="/assets/svgs/alert-bg-circle.svg" alt="Alert Background Cirlce">
        <img src="/assets/svgs/alert-bg-effect.svg" alt="Alert Background Effect">
      </div>
      <div class="auto__container">
        <div class="alert__top">
          <div class="alert__top-info">
            <h2 class="alert__top-info-title">
              We informed our subscribers on Luna crash few months in advance!
            </h2>
            <div class="alert__top-info-subtitle"> Just "short"instead "long" correct coin! </div>
            <button class="button primary">
              ...
              >
                <path
                  d="M6.38347 1.28065L7.03131 0.632812C7.32578 0.367788 7.76748 0.367788 8.03251 0.632812L13.7747 6.34555C14.0397 6.64002 14.0397 7.08173 13.7747 7.34675L8.03251 13.0889C7.76748 13.354 7.32578 13.354 7.03131 13.0889L6.38347 12.4411C6.11845 12.1466 6.11845 11.7049 6.38347 11.4105L9.94657 8.02404H1.49525C1.08299 8.02404 0.788518 7.72957 0.788518 7.31731V6.375C0.788518 5.99219 1.08299 5.66827 1.49525 5.66827H9.94657L6.38347 2.3113C6.11845 2.01683 6.089 1.57512 6.38347 1.28065Z"
                  fill="currentColor"
                />
              </svg>
            </button>
          </div>
          <div class="alert__chart">
            <div class="alert__chart-shadows">
              <span>
                <img
            ...
            <div class="alert__chart-content">
              <img src="/assets/images/alert-chart.png" alt="Stock chart" />
            </div>
          </div>
        </div>
        <div class="alert__bottom">
          <div class="alert__card-wrapper" data-aos="flip-right" >
            <div class="alert__card">
              <div class="alert__card-icon">
                <img src="/assets/svgs/alert-card-icon-1.svg" alt="Alert Card Icon" />
              </div>
              <h4>Alerts accross the industry</h4>
              <p>
                I addition to this - we have purchased all the other alerts
                accross the industry - and this costs thousant - so we know
                everything. Here is can get this for a fraction of price. In
                order to get those "signals" you would be paying thosands a
                month.
              </p>
            </div>
          </div>
          <div class="alert__card-wrapper" data-aos="flip-right" data-aos-delay="150">
            <div class="alert__card">
              <div class="alert__card-icon">
                <img src="/assets/svgs/alert-card-icon-2.svg" alt="Alert Card Icon" />
              </div>
              <h4>Win - Win situation just was founded!</h4>
              <p>
                Purchase now as the price will not go lower just as its coslty
                to support high quality copy paste trading alerts - as it takes
                many expencive people time and effort!
              </p>
            </div>
          </div>
          <div class="alert__card-wrapper" data-aos="flip-right" data-aos-delay="300">
            <div class="alert__card">
              <div class="alert__card-icon">
                <img src="/assets/svgs/alert-card-icon-3.svg" alt="Alert Card Icon" />
              </div>
              <h4>In addition to our proprietary signals</h4>
              <p>
                In addition to our proprietary signals, we have invested heavily
                in acquiring premium alert services across various industries.
                This allows us to remain ahead of the curve and capitalize on
                unique opportunities others miss.
              </p>
            </div>
          </div>
      </div>
      ...
      <div class="auto__container">
        <div class="stats__inner">
          <div class="stats__title">
            Last 2 years weren't biggest bull run times, and yet BTC nailed best
            perfoming asset
          </div>
          <div class="stats__content">
            <div class="stats__block">
              <img src="/assets/images/stat-1.png" alt="Stat" />
            </div>
            <div class="stats__block">
              <img src="/assets/images/stat-2.png" alt="" />
            </div>
          </div>
        </div>
      </div>
