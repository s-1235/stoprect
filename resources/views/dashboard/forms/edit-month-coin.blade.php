...
<div class="container">
    <div class="row">
        ...
        <div class="col-12">
            <h3 class="my-5"><a href="{{route('month-coin')}}">Month coin</a> >> Edit coin of month</h3>

            <form method="post" action="{{route('edit-month-coin')}}" class="form-inline" enctype="multipart/form-data">
