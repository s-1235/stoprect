...
<div class="container">
    <div class="row">
        ...
        <div class="col-12">
            <h3 class="my-5"><a href="{{route('month-coin')}}">Coin of the month</a> >> Add coin of month</h3>
            @include('dashboard.help-text.help-text',[
                'helpText' => config('constants.help-text.add-coin-month')
            ])
            <form method="post" action="{{route('add-coin-month')}}" class="form-inline" enctype="multipart/form-data">
                ...
                <div class="form-group col-12 mb-2 expl_text">
