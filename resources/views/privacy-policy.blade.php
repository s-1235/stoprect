...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="public/assets/css/styles3.css" />
    <link type="text/css" rel="stylesheet" href="public/assets/css/responsive.css" />
    <link type="text/css" rel="stylesheet" href="public/assets/css/plan-section.css" />
...
<!-- crypto aggregator -->
<section class="dashboard-section" id="instructions">
<span class="blur-round"></span>
<div class="container">

{{--    <p><h5 class="wow fadeInUp" style="margin-left:6%">PRI</h5></p>--}}
            ...
            <div class="row">
                <div class="col-100">
                    ...
                    <ul>
                        ...
                        <li>To send periodic emails regarding your order of products, services or events</li>
                    ...
                    <h3><strong>Types of data</strong></h3>
                    <p>We separate the type of data we collect in two categories; non-sensitive and sensitive data.</p>
                    <p>Non-sensitive data:</p>
                    <ul>
                        <li>Contact: name, address, telephone, mobile, email address</li>
                        <li>Identification: sex, data of birth, location, nationality</li>
                        <li>Transaction: license information, support points, course participation, event participation</li>
                        <li>Communication on all channels and social media: emails, online chat history, comments, feedback, testimonials</li>
                        <li>Digital including all website and digital platforms: IP address, cookies, social communication, engagement patterns and information, photos, videos</li>
                    </ul>
                    <p>Sensitive data:</p>
                    <ul>
                        <li>Health: Allergies, injuries</li>
                    </ul>
                    <h3><strong>Third-party disclosure</strong></h3>
                    <p>We do not sell, trade, or otherwise transfer the data we collect to outside parties. This does not include website hosting partners and other parties who assist us in operating our website, conducting our business, or serving our users, so long as those parties agree to keep this information confidential. We may also release information when it's release is appropriate to comply with the law, enforce our site policies, or protect ours or others' rights, property or safety.&nbsp;However, non-personally identifiable visitor information may be provided to other parties for marketing, advertising, or other uses.</p>
                    <h3><strong>Third-party providers</strong></h3>
                    <p>Google's advertising requirements can be summed up by Google's Advertising Principles. They are put in place to provide a positive experience for users&nbsp;<a href="https://support.google.com/adwordspolicy/answer/1316548?hl=en">https://support.google.com/adwordspolicy/answer/1316548?hl=en</a>. We, along with third-party vendors such as Google use first-party cookies (such as the Google Analytics cookies) to compile data regarding user interactions with ad impressions and other ad service functions as they relate to our website. Users can set preferences for how Google advertises to you using the Google Ad Settings page. Alternatively, you can opt out by visiting the Network Advertising Initiative Opt Out page or by using the Google Analytics Opt Out Browser add on.</p>
                    <h3><strong>Remove your data from Stoprect.com</strong></h3>
                    <p>Marketing communication:</p>
                    <p>You can at any time unsubscribe or change your subscription from future emails by following the instructions at the bottom of each email or by sending an email to&nbsp;<a href="mailto:marketing@stoprect.com">marketing@stoprect.com</a>. Your subscription will then be automatically updated. You cannot unsubscribe from communication directly with our sales department if we provide you with services and/or software on following topics; price information or other vital information on your account.</p>
                    <p>Personal data from all our departments in Stoprect.com:</p>
                   
                    <h3><strong>Contact information</strong></h3>
                    <p>Please contact us if you have further questions regarding our privacy policy <a href="mailto:gdpr@stoprect.com">gdpr@stoprect.com</a>.</p>
                    <p>&nbsp;</p>
                </div>
            </div>
